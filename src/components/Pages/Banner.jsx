...
const Banner = () => {
  return (
    <div className=" bg-amber-600 flex items-center p-6 lg:p-10 overflow-hidden relative mb-12">
        <div className="relative items-center justify-center w-full overflow-x-hidden p-5 lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-40 rounded bg-white shadow-xl  mx-auto text-gray-800 ">
          <div className=" flex flex-col items-center justify-between h-full  px-2 lg:px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
            <div className="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
              ...
              <p className="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
                ...
                ToyCarPlaza is the best place to find the perfect toy car for
                your child.
              </p>
              <Link
                to="/sing-up"
